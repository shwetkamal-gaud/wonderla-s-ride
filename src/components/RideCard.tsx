  ...
  return (
    <div >
      <div className="relative h-[394px] w-[229px] overflow-hidden rounded-t-[26px] lg:h-[346px] lg:min-w-[246px] lg:rounded-t-[22px]">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(180deg,_rgba(51,77,207,0)_50%,_#334DCF_100%)] lg:bg-[linear-gradient(180deg,_rgba(34,48,74,0)_34.08%,_#22304A_100%)]">
        ...
        <div className="absolute bottom-0 left-0 right-0 flex flex-col px-3 pb-2.5 text-white lg:pb-1">
          ...
          <a className="inline-block w-full max-w-[150px]" href="/kochi/rides/happy-kangaroo">
            <div className="h-10 w-full max-w-[150px]  rounded-lg text-xs font-black uppercase leading-tight flex items-center justify-center text-blue bg-yellow-400 mt-2" tabIndex={0}>
              Ride Details</div>
          </a>
        </div>
      </div>
